...
export function ScrollingMarquee() {
  const messages = [
    "Garantia de Crecimiento",
    "Pago Seguro y Envio Rastreado Rapido",
    "🌸 La primavera empieza el 20 de marzo — Planta ahora, florece toda la temporada | Envio gratuito en todos los kits 🌸",
    "Garantia de Crecimiento",
    "Pago Seguro y Envio Rastreado Rapido",
  ]
