...
const reviews = [
  {
    ...
    text: "The vibe is totally different now — tropical, almost like a private vacation spot. It's the first thing my friends comment on when they come over.",
  },
  {
    id: 2,
    ...
    text: "The beauty of these flowers takes me far away from the noise and concrete.",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    text: "Between work, family, and the daily grind, I rarely get a moment to myself. My little corner with the Hibiscus has become my sanctuary. Tending to it for five minutes, seeing the incredible color of the flowers — that's my meditation. It's my daily dose of calm.",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    text: "The results speak for themselves: an abundant and spectacular bloom. For anyone who takes gardening seriously, this is a no-brainer.",
  },
  {
    id: 7,
    image: 'https://dxy4adpuoflk7uxq.public.blob.vercel-storage.com/Versia%20Garden/Kit%20hibiscus/image%20877.png',
    text: "We just moved, and I was looking for that one piece to make the house truly feel like home. I found it in this Hibiscus. With its burst of color, it brought the exact energy and personality our living room was missing.",
  },
  {
    id: 8,
    image: 'https://dxy4adpuoflk7uxq.public.blob.vercel-storage.com/Versia%20Garden/Kit%20hibiscus/image%20878.png',
    text: "My husband gave me this Hibiscus for our anniversary, and it's the most special gift I've ever received. Instead of flowers that die in a week, I got flowers that bloom every week! Every new bud feels like a celebration.",
  },
  {
    id: 9,
