...
export default function Upsell1PageFR() {
  ...
  const handleAccept = async () => {
    ...
    try {
      ...
      router.push(`/fr/upsell2?email=${encodeURIComponent(email || "")}&customer=${encodeURIComponent(customer)}&upsell1_accepted=true`)
    } catch (error) {
  ...
  const handleDecline = () => {
    router.push(`/fr/upsell2?email=${encodeURIComponent(email || "")}&customer=${encodeURIComponent(customer || "")}`)
  }
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      <div className="bg-[#002F5D] text-white text-center py-2 px-4">
        <p className="text-sm">
          {"Ne fermez pas cette page. Important : Ne cliquez pas sur \u2018Retour\u2019 et ne fermez pas cette page."}
        </p>
      </div>
      ...
      <main className="w-full max-w-md mx-auto px-3 sm:px-4 py-6 sm:py-8">
        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-center mb-6 sm:mb-8 leading-tight px-2">
          {"VOTRE KIT D\u2019HIBISCUS EST EN ROUTE !"}{' '}
              ...
              <div className="relative h-full flex flex-col items-center justify-between p-6 text-center">
                ...
                <div className="pb-4">
                  <Image
                    ...
                    alt="Botaniste avec Guide Pratique"
                    width={280}
                    height={200}
                    sizes="280px"
                  ...
                  <p className="text-xs text-gray-600 mt-2 font-semibold">
                    Guide Pratique par Versia Garden
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="text-center mb-4 sm:mb-6 px-2">
          <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
            {"La plupart des nouveaux jardiniers commettent 3 erreurs critiques d\u00e8s la premi\u00e8re semaine qui tuent leurs fleurs. Notre Botaniste en Chef a cr\u00e9\u00e9 20 le\u00e7ons vid\u00e9o exclusives pour s\u2019assurer que VOTRE hibiscus s\u2019\u00e9panouisse \u2014 "}{' '}
            <span className="bg-[#66bb6a] text-white px-2 py-1 font-bold inline-block">
              {"ENTI\u00c8REMENT GRATUIT"}
            </span>
            {". Il vous suffit de cliquer sur le bouton ci-dessous pour y acc\u00e9der imm\u00e9diatement :"}
          </p>
        </div>
        ...
        >
          {isLoading ? "Traitement en cours..." : "Oui, je le veux ! \u2192"}
        </Button>
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-3">
              ...
              <span className="text-sm text-gray-700">
                {"Apprenez le programme d\u2019arrosage exact et les besoins en lumi\u00e8re pour chaque couleur d\u2019hibiscus"}
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Check className="h-5 w-5 text-[#66bb6a] flex-shrink-0 mt-0.5" />
              <span className="text-sm text-gray-700">
                {"D\u00e9couvrez comment prot\u00e9ger vos plantes durant leur premier hiver \u2014 m\u00eame sous les climats froids"}
              </span>
            </li>
            <li className="flex items-start gap-3">
              <Check className="h-5 w-5 text-[#66bb6a] flex-shrink-0 mt-0.5" />
              <span className="text-sm text-gray-700">
                {"100% Gratuit \u2014 Aucun frais aujourd\u2019hui, aucune carte bancaire requise pour l\u2019acc\u00e8s"}
              </span>
            </li>
          </ul>
        </div>
