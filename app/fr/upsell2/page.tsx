...
export default function Upsell2PageFR() {
  ...
  const [selectedColor, setSelectedColor] = useState("Offre Sp\u00e9ciale - Kit Plante Hibiscus 4 Couleurs (Jaune, Violet, Rouge et Rose)")
  ...
  const colorOptions = [
    { 
      id: "special-offer", 
      label: "Offre Sp\u00e9ciale - Kit Plante Hibiscus 4 Couleurs (Jaune, Violet, Rouge et Rose)",
      price: 19.87,
      imageIndex: 0
    },
    { 
      id: "red", 
      label: "Hibiscus Rouge - Lot de 4",
      price: 24.87,
      imageIndex: 1
    },
    { 
      id: "yellow", 
      label: "Hibiscus Jaune - Lot de 4",
      price: 24.87,
      imageIndex: 2
    },
    { 
      id: "pink", 
      label: "Hibiscus Rose - Lot de 4",
      price: 24.87,
      imageIndex: 3
    },
    { 
      id: "purple", 
      label: "Hibiscus Violet - Lot de 4",
      price: 24.87,
      imageIndex: 4
    },
  ]
  ...
  const handleAccept = async () => {
    ...
    if (!customer) {
      setErrorMessage("Identifiant client introuvable. Veuillez contacter le support.")
      setIsLoading(false)
      return
    }
    ...
    try {
      ...
      router.push(`/fr/thank-you?email=${encodeURIComponent(email || "")}&upsell2=true`)
    } catch (error) {
  ...
  const handleDecline = () => {
    router.push(`/fr/thank-you?email=${encodeURIComponent(email || "")}`)
  }
      ...
      <main className="w-full max-w-6xl mx-auto py-4 sm:py-8 px-3 sm:px-4">
        <div className="text-center mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-3 sm:mb-4 text-balance px-2">
            {"Imaginez 8 Couleurs \u00c9clatantes Fleurissant dans Votre Jardin au Lieu de Seulement 4."}
          </h1>
          <p className="text-sm sm:text-base text-muted-foreground max-w-4xl mx-auto text-pretty px-2">
            {"Votre premier kit remplira votre int\u00e9rieur de 4 couleurs magnifiques. Maintenant, imaginez doubler ce spectacle \u2014 un arc-en-ciel complet d\u2019hibiscus vous accueillant chaque matin. Pour vous remercier de votre commande, nous vous proposons un second Kit de 4 Hibiscus \u00e0 50% DE R\u00c9DUCTION. Pas besoin de ressaisir vos coordonn\u00e9es \u2014 cliquez simplement ci-dessous pour l\u2019ajouter \u00e0 votre livraison."}
          </p>
        </div>

        <div className="bg-blue-50 border border-blue-100 rounded-lg p-3 sm:p-4 text-center mb-6 sm:mb-8 max-w-md mx-auto">
          <p className="text-sm sm:text-base text-foreground">
            {"L\u2019offre expire dans : "}<span className="text-red-600 font-bold">{formatTime(timeLeft)}</span>
          </p>
        </div>
          ...
          <div className="space-y-4 sm:space-y-6">
            <div>
              <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-2">
                {"Kit de Plantules de Fleurs d\u2019Hibiscus Rares | Multicolore"}
              </h2>
              <p className="text-xs uppercase text-muted-foreground mb-3 sm:mb-4 tracking-wide">
                {"OFFRE SP\u00c9CIALE - KIT PLANTE HIBISCUS 4 COULEURS (JAUNE, VIOLET, ROUGE ET ROSE)"}
              </p>
            ...
            <div className="space-y-3">
              <label className="text-sm font-semibold block">{"Couleur de la Fleur - "}{selectedColor}</label>
            ...
            <div className="border border-border rounded-lg p-3 sm:p-4 space-y-2">
              ...
              <div className="flex justify-between text-sm sm:text-base">
                <span className="text-muted-foreground">{"R\u00e9duction (50%)"}</span>
              ...
              <p className="text-xs text-muted-foreground">{"Taxes incluses : \u20ac 0,00"}</p>
            </div>
            ...
            >
              {isLoading ? "Traitement en cours..." : "OUI, JE VEUX CETTE OFFRE !"}
            </Button>
            ...
            >
              {"Non merci, 4 couleurs me suffisent"}
            </Button>
